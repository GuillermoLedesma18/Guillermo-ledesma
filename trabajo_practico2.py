...
if respuesta == "t" or respuesta == "c":                            #Confirmo de que haya elegido una respuesta válida
    if respuesta == "t":                                            #En caso de haber elegido t pido los datos para realizar el cálculo del área del triangulo
        ...
        radio = float(input("Ingrese el radio del circulo a calcular: ")) #En caso de no haber elegido t pido los datos para realizar el cálculo del área del círculo
        area_c = (radio**2)*math.pi
        print(f"El resultado del área del círculo es: {area_c}")
else:
    print("No a elegido ninguna de las dos opciones")                       #si no ha elegido una respuesta válido imprimo que no ha elegido ninguna opción
